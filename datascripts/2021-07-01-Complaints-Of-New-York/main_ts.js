...
var prepVariables = function(data) {
    ...
    for (var k = 0; k < data.length; k++){
        ...
        else if (data[k].complaint_type.toLowerCase().includes('covid')) {
            data[k].complaint_class = 'Covid'
        }
        else if (data[k].descriptor && data[k].descriptor.toLowerCase().includes('covid')) {
            data[k].complaint_class = 'Covid'
        }
        else if (data[k].descriptor && data[k].descriptor.toLowerCase().includes('social distancing')) {
            data[k].complaint_class = 'Covid'
        }
        else {
